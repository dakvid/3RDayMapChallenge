...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <div class="container">
    <span class="navbar-brand">#30DayMapChallenge #RStats</span>
...
<div class="container">
  ...
  <div class="page-header" id="banner">
    <div class="row">
      <div class="col-12">
        <h1>30 Day Map Challenge in R</h1>
        <p class="lead">A collection of awesome maps from Twitter. With code!</p>
      </div>
    </div>
  </div>
')
